...
<div class="max-w-xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl sm:text-2xl font-semibold text-[#1d1d1f] tracking-tight">Catat Pengeluaran</h1>
            <p class="text-xs text-[#86868b] mt-1">Input data biaya operasional atau pengeluaran toko</p>
        </div>
    ...
    <div class="apple-card p-6">
        <form action="{{ route('expenses.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="judul" value="{{ old('judul') }}" required placeholder="Misal: Pembayaran Listrik & Air"
            ...
            <div>
                <label class="block text-xs font-semibold text-[#1d1d1f] mb-1.5">Keterangan Tambahan</label>
                <textarea name="keterangan" rows="3" placeholder="Catatan pengeluaran (opsional)..."
                    class="apple-input h-auto py-2">{{ old('keterangan') }}</textarea>
            </div>
